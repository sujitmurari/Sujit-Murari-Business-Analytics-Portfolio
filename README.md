...
| Page | Description |
|------|-------------|
| Home | Animated boot sequence, hero section, KPI counters |
| Skills | Tech stack — Python, SQL, Tableau, Excel, Pandas |
| Projects | Data analytics case studies and writeups |
| Analytics Lab | Live CSV/XLSX ingestion, charts, correlation heatmap |
| About | Background, education, tools |
| Connect | LinkedIn, GitHub, Tableau Public, Email |
...
- **Analytics:** Chart.js, custom CSV/XLSX parser
- **Deployment:** Cloudflare Pages
- **Domain:** sujitmurari.is-a.dev
